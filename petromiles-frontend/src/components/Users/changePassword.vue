...
export default {
  ...
  methods: {
    ...
    async checkingValidForm() {
      ...
      if (
        !this.$v.$invalid &&
        this.password === this.confirmedNewPassword &&
  ...
  computed: {
    ...
    currentPasswordErrors() {
      ...
      !this.$v.currentPassword.required &&
        this.password !== "" &&
        errors.push(`${this.$tc("error-messages.currentPasswordRequired")}`);
      return errors;
    },
    passwordErrors() {
      const errors = [];
      ...
      !this.$v.password.minLength &&
        errors.push(`${this.$tc("error-messages.PasswordMinLength")}`);
      !this.$v.password.maxLength &&
        errors.push(`${this.$tc("error-messages.PasswordMaxLength")}`);
      return errors;
    },
    confirmedNewPasswordError() {
      ...
      this.confirmedNewPassword !== this.password &&
        errors.push(`${this.$tc("error-messages.PasswordsAreNotEqual")}`);
      return errors;
    },
  },
};
