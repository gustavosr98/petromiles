          ...
          <template v-for="(account, index) in bankAccountsToVerify">
            ...
            >
              <v-list-item-content class="text--primary subtitle-2">
                ...
                <p>
                  {{$t("common.type")}}:
                  <span class="subtitle-2 font-weight-light">{{account.type}}</span>
                </p>
              </v-list-item-content>
...
<script>
import InformationAlert from "@/components/messages/InformationAlert";
import VerificationModal from "@/modules/BankAccount/components/BankAccountVerification/VerificationModal";
