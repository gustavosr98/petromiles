...
context("Change Password", () => {
    ...
    it("Trying to Change Password with all the fields empty", () => {
    ...
    it("Trying to Change Password with only the current password field filled correctly", () => {
    ...
    it("Trying to Change Password with only the current password field filled wrongly", () => {
    ...
    it("Trying to Change Password with only the current password field and new password field filled", () => {
        cy.get('[data-cy=current-password-input]').type("test1234");
    ...
    it("Trying to Change Password with a incorrect current password", () => {
    ...
    it("Trying to Change Password with a invalid short password", () => {
        cy.get('[data-cy=current-password-input]').type("test1234");
    ...
    it("Trying to Change Password with a invalid long password", () => {
        cy.get('[data-cy=current-password-input]').type("test1234");
