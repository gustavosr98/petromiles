...
describe('MailsService', () => { 
  ...
  beforeEach(() => {
    ...
    SendGridConfigMock = jest.fn<Partial<typeof SendGridConfig>, typeof SendGridConfig[]>(
      () => ({
    ...
    let emailFrom;
      ...
      describe('when everything works well', () => {
        ...
        it('should invoke sendGridService.send()', () => {
          ...
          expect(sendGridService.send).toHaveBeenCalledWith({ ...mailParameters, emailFrom });
        });
			});
    });
