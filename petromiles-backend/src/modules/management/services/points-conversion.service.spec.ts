...
describe('pointsConversionService', ()=>{
   ...
   beforeEach( async ()=>{
      ...
      pointsConversionService = module.get<PointsConversionService>(PointsConversionService);
      pointsConversionRepository = module.get(getRepositoryToken(PointsConversion));
   });
